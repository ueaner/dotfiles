...
ansible-playbook ~/.ansible/unix.yml --extra-vars "role=packages task=download" --tags lang
ansible-playbook ~/.ansible/unix.yml --extra-vars "role=packages task=install" --tags lang
...
# ansible-playbook ~/.ansible/unix.yml --extra-vars "role=packages" --tags gnome-shell-extensions
ansible-playbook ~/.ansible/unix.yml --extra-vars "role=packages task=download" --tags gnome-shell-extensions
ansible-playbook ~/.ansible/unix.yml --extra-vars "role=packages task=install" --tags gnome-shell-extensions
```
