...
--- Done
---
---   function done(summary: table, latency: table, requests: integer)
---
...
---#DES 'wrk.thread'
---@class wrk.thread: table
---@field addr  string   Get or set the thread's server address
wrk.thread = {}

---#DES 'wrk.thread:stop'
---@return boolean ok
function wrk.thread:stop() end

---#DES 'wrk.thread:get'
---@return string name Get the value of a global in the thread's env
function wrk.thread:get(name) end

---#DES 'wrk.thread:set'
function wrk.thread:set(name, value) end
...
function wrk.format(method, path, headers, body) end

---#DES 'wrk.lookup'
---@param host     string
---@param service  string  wrk.port or "http"
---@return string[] addrs
function wrk.lookup(host, service) end

---#DES 'wrk.connect'
---@param addr  string
---@return boolean
function wrk.connect(addr) end
